    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="alert alert-warning">
                ...
                <?php esc_html_e('Expert not specified.', 'maneli-car-inquiry'); ?>
            </div>
        </div>
    </div>
    <?php
...
if (!$expert || !in_array('maneli_expert', $expert->roles)) {
    ?>
    <div class="row">
        <div class="col-xl-12">
            <div class="alert alert-danger">
                <i class="la la-exclamation-triangle me-2"></i>
                <?php esc_html_e('Expert not found.', 'maneli-car-inquiry'); ?>
            </div>
        </div>
    </div>
    <?php
            ...
            <div>
                <nav>
                    <ol class="breadcrumb mb-1">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo esc_url(home_url('/dashboard/experts')); ?>"><?php esc_html_e('Expert Management', 'maneli-car-inquiry'); ?></a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $is_edit_mode ? esc_html__('Edit', 'maneli-car-inquiry') : esc_html__('View', 'maneli-car-inquiry'); ?> <?php esc_html_e('Expert', 'maneli-car-inquiry'); ?></li>
                    </ol>
                </nav>
                <h1 class="page-title fw-medium fs-18 mb-0"><?php echo $is_edit_mode ? esc_html__('Edit Expert', 'maneli-car-inquiry') : esc_html__('Expert Details', 'maneli-car-inquiry'); ?></h1>
            </div>
            <div>
                ...
                <div class="card custom-card">
                    <ul class="nav nav-tabs tab-style-8 scaleX rounded m-3 profile-settings-tab gap-2" id="expertDetailTabs" role="tablist">
                        <li class="nav-item me-1" role="presentation">
                            <button class="nav-link px-4 bg-primary-transparent <?php echo ($active_tab === 'account' || $active_tab === '') ? 'active' : ''; ?>" id="account-tab" data-bs-toggle="tab" data-bs-target="#account-pane" type="button" role="tab" aria-controls="account-pane" aria-selected="<?php echo ($active_tab === 'account' || $active_tab === '') ? 'true' : 'false'; ?>">
                                <?php esc_html_e('Account', 'maneli-car-inquiry'); ?>
                            </button>
                        </li>
                        <li class="nav-item me-1" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link px-4 bg-primary-transparent <?php echo $active_tab === 'permissions' ? 'active' : ''; ?>" id="permissions-tab" data-bs-toggle="tab" data-bs-target="#permissions-pane" type="button" role="tab" aria-controls="permissions-pane" aria-selected="<?php echo $active_tab === 'permissions' ? 'true' : 'false'; ?>">
                                <?php esc_html_e('Permissions', 'maneli-car-inquiry'); ?>
                            </button>
                        </li>
                    </ul>
                    <div class="p-3 border-bottom border-top border-block-end-dashed tab-content">
                        ...
                        <div class="tab-pane <?php echo ($active_tab === 'account' || $active_tab === '') ? 'show active' : ''; ?> overflow-hidden p-0 border-0" id="account-pane" role="tabpanel" aria-labelledby="account-tab" tabindex="0">
                            <div class="p-4">
                                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-1">
                                    <div class="fw-semibold d-block fs-15"><?php echo $is_edit_mode ? esc_html__('Edit Account', 'maneli-car-inquiry') : esc_html__('Account Information', 'maneli-car-inquiry'); ?>:</div>
                                    <?php if ($is_edit_mode): ?>
                                ...
                                <div class="row gy-3">
                                    <div class="col-xl-6">
                                        ...
                                        <?php if ($is_edit_mode): ?>
                                            <input type="text" class="form-control" id="edit-expert-first-name" value="<?php echo esc_attr($expert->first_name); ?>" placeholder="<?php esc_attr_e('First Name', 'maneli-car-inquiry'); ?>">
                                        <?php else: ?>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <?php if ($is_edit_mode): ?>
                                            <input type="text" class="form-control" id="edit-expert-last-name" value="<?php echo esc_attr($expert->last_name); ?>" placeholder="<?php esc_attr_e('Last Name', 'maneli-car-inquiry'); ?>">
                                        <?php else: ?>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <?php if ($is_edit_mode): ?>
                                            <select class="form-select" id="edit-expert-status">
                                                <option value="yes" <?php selected($is_active, true); ?>><?php esc_html_e('Active', 'maneli-car-inquiry'); ?></option>
                                                <option value="no" <?php selected($is_active, false); ?>><?php esc_html_e('Inactive', 'maneli-car-inquiry'); ?></option>
                                            </select>
                                        <?php else: ?>
                                            <div class="form-control-plaintext">
                                                <span class="badge bg-<?php echo $is_active ? 'success' : 'danger'; ?>">
                                                    <?php echo $is_active ? esc_html__('Active', 'maneli-car-inquiry') : esc_html__('Inactive', 'maneli-car-inquiry'); ?>
                                                </span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <div class="tab-pane <?php echo $active_tab === 'inquiries' ? 'show active' : ''; ?> overflow-hidden p-0 border-0" id="inquiries-pane" role="tabpanel" aria-labelledby="inquiries-tab" tabindex="0">
                            <div class="p-4">
                                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-1">
                                    <div class="fw-semibold d-block fs-15"><?php esc_html_e('Assigned Inquiries:', 'maneli-car-inquiry'); ?></div>
                                            ...
                                            <table class="table table-hover table-bordered">
                                                ...
                                                <tbody>
                                                    <?php foreach ($cash_inquiries as $inquiry): 
                                                        ...
                                                        $status_display = [
                                                            'new' => ['label' => esc_html__('New', 'maneli-car-inquiry'), 'class' => 'info'],
                                                            'in_progress' => ['label' => esc_html__('Under Review', 'maneli-car-inquiry'), 'class' => 'warning'],
                                                            'approved' => ['label' => esc_html__('Approved', 'maneli-car-inquiry'), 'class' => 'success'],
                                                            'rejected' => ['label' => esc_html__('Rejected', 'maneli-car-inquiry'), 'class' => 'danger'],
                                ...
                                <?php if (empty($installment_inquiries) && empty($cash_inquiries)): ?>
                                    <div class="alert alert-info">
                                        ...
                                        <?php esc_html_e('No inquiries have been assigned to this expert.', 'maneli-car-inquiry'); ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane <?php echo $active_tab === 'permissions' ? 'show active' : ''; ?> overflow-hidden p-0 border-0" id="permissions-pane" role="tabpanel" aria-labelledby="permissions-tab" tabindex="0">
                            <div class="p-4">
                                <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-1">
                                    <div class="fw-semibold d-block fs-15"><?php esc_html_e('Permission Management:', 'maneli-car-inquiry'); ?></div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-check form-switch mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="permission-cash-inquiry">
                                                <i class="la la-money-bill-wave me-2"></i>
                                                <?php esc_html_e('Access to Cash Inquiries', 'maneli-car-inquiry'); ?>
                                            </label>
                                            <p class="text-muted fs-12 mt-1 mb-0"><?php esc_html_e('Expert can view and manage cash inquiries.', 'maneli-car-inquiry'); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="form-check form-switch mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="permission-installment-inquiry">
                                                <i class="la la-bank me-2"></i>
                                                <?php esc_html_e('Access to Installment Inquiries', 'maneli-car-inquiry'); ?>
                                            </label>
                                            <p class="text-muted fs-12 mt-1 mb-0"><?php esc_html_e('Expert can view and manage installment inquiries.', 'maneli-car-inquiry'); ?></p>
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
                                        <div class="form-check form-switch mb-3">
                                            ...
                                            <label class="form-check-label fw-semibold" for="permission-calendar">
                                                ...
                                                <?php esc_html_e('Access to Meeting Calendar', 'maneli-car-inquiry'); ?>
                                            </label>
                                            <p class="text-muted fs-12 mt-1 mb-0"><?php esc_html_e('Expert can view and manage meetings.', 'maneli-car-inquiry'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
const maneliTranslations = {
    ...
    expertUpdated: <?php echo wp_json_encode(esc_html__('Expert information updated successfully.', 'maneli-car-inquiry')); ?>,
