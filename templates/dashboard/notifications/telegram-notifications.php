    ...
    <div class="container-fluid">
        ...
        <div class="card custom-card mb-4 maneli-mobile-filter-card" data-maneli-mobile-filter>
            ...
            <div class="card-body maneli-mobile-filter-body" data-maneli-filter-body>
                <form method="get" action="<?php echo esc_url(home_url('/dashboard/notifications/telegram')); ?>">
                    <div class="row g-3">
                        <div class="col-12">
                    ...
                    <div class="row g-2 mt-3">
                        ...
                        <div class="col-6 col-lg-auto">
                            <a href="<?php echo esc_url(home_url('/dashboard/notifications/telegram')); ?>" class="btn btn-secondary btn-wave w-100">
