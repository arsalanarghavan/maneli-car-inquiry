 ...
 * مدیریت تلگرام - صفحه تخصصی Telegram
 */
...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    header('Content-Disposition: attachment; filename=telegram-notifications-' . date('Y-m-d') . '.csv');
    ...
    <div class="container-fluid">
            ...
            <div>
                <nav>
                    <ol class="breadcrumb mb-1">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php esc_html_e('Telegram Notifications', 'maneli-car-inquiry'); ?></li>
                    </ol>
                </nav>
                <h1 class="page-title mb-0"><?php esc_html_e('Telegram Notifications', 'maneli-car-inquiry'); ?></h1>
            </div>
        </div>
        <!-- End::page-header -->
            ...
            <div class="col-xl col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card custom-card crm-card overflow-hidden">
                    <div class="card-body">
                        ...
                        <p class="flex-fill text-muted fs-14 mb-1"><?php esc_html_e('Total Telegram', 'maneli-car-inquiry'); ?></p>
                        <div class="d-flex align-items-center justify-content-between mt-1">
                ...
                <div class="card custom-card crm-card overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                            ...
                            <span class="badge bg-info-transparent rounded-pill fs-11"><?php esc_html_e('Messages', 'maneli-car-inquiry'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-card crm-card overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                            ...
                            <span class="badge bg-secondary-transparent rounded-pill fs-11"><?php esc_html_e('Messages', 'maneli-car-inquiry'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card custom-card mb-4 maneli-mobile-filter-card" data-maneli-mobile-filter>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-success btn-wave" data-bs-toggle="modal" data-bs-target="#sendSingleModal">
                            <i class="ri-telegram-line me-1"></i>
            ...
            <div class="card-body maneli-mobile-filter-body" data-maneli-filter-body>
                <form method="get" action="<?php echo esc_url(home_url('/dashboard/notifications/telegram')); ?>" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-12">
                        ...
                        <a href="<?php echo esc_url(home_url('/dashboard/notifications/telegram')); ?>" class="btn btn-secondary btn-wave">
        ...
        <div class="row mb-4">
            <div class="col-xl-6">
                <div class="card custom-card">
                    <div class="card-header">
                        <h5 class="mb-0"><?php esc_html_e('Telegram Timeline', 'maneli-car-inquiry'); ?></h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="card custom-card mb-4">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0"><?php esc_html_e('Telegram Logs', 'maneli-car-inquiry'); ?></h5>
                            ...
                            <?php if (empty($logs)): ?>
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <p class="text-muted mb-0"><?php esc_html_e('No Telegram notifications found.', 'maneli-car-inquiry'); ?></p>
                                    </td>
                                </tr>
                            <?php else: ?>
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-center mt-4">
                            ...
                            $base_url = add_query_arg([
                                ...
                                'date_to' => $date_to,
                                'search' => $search,
                            ], home_url('/dashboard/notifications/telegram'));
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php esc_html_e('Send Single Telegram', 'maneli-car-inquiry'); ?></h5>
            ...
            <div class="modal-body">
                <form id="sendSingleForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="recipient" id="singleRecipient" class="form-control" required placeholder="<?php esc_attr_e('Chat ID or User ID', 'maneli-car-inquiry'); ?>">
                        <small class="form-text text-muted"><?php esc_html_e('Enter Telegram Chat ID or user ID', 'maneli-car-inquiry'); ?></small>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="sendSingleBtn">
                    <i class="ri-send-plane-line me-1"></i>
                    <?php esc_html_e('Send Telegram', 'maneli-car-inquiry'); ?>
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="sendBulkModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php esc_html_e('Send Bulk Telegram', 'maneli-car-inquiry'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="bulkNotificationForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="custom_recipients" id="bulkCustomRecipients" class="form-control" rows="3" placeholder="<?php esc_attr_e('Or enter custom Chat IDs (one per line)', 'maneli-car-inquiry'); ?>"></textarea>
...
<div class="modal fade" id="scheduleModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php esc_html_e('Schedule Telegram', 'maneli-car-inquiry'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="scheduleNotificationForm">
                    ...
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Recipient', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="recipient" id="scheduleRecipient" class="form-control" required placeholder="<?php esc_attr_e('Chat ID or User ID', 'maneli-car-inquiry'); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Message', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
...
jQuery(document).ready(function($) {
                    ...
                    if (response.success && response.data) {
                        var timelineChart = new Chart(timelineCtx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    label: '<?php echo esc_js(__('Sent Telegram', 'maneli-car-inquiry')); ?>',
    ...
    $('#exportBtn').on('click', function() {
        ...
        window.location.href = '<?php echo esc_url(home_url('/dashboard/notifications/telegram')); ?>?' + params.toString();
    });
    ...
    $('#sendSingleBtn').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Telegram sent successfully!', 'maneli-car-inquiry')); ?>');
            ...
            complete: function() {
                btn.prop('disabled', false).html('<i class="ri-send-plane-line me-1"></i> <?php echo esc_js(__('Send Telegram', 'maneli-car-inquiry')); ?>');
            }
        });
    });
    ...
    $('#sendBulkBtn').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Bulk Telegram sent successfully!', 'maneli-car-inquiry')); ?>');
    ...
    $('#scheduleBtn').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Telegram scheduled successfully!', 'maneli-car-inquiry')); ?>');
    ...
    $('.retry-notification').on('click', function() {
        ...
        if (!confirm('<?php echo esc_js(__('Retry sending this Telegram?', 'maneli-car-inquiry')); ?>')) {
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Telegram retried successfully!', 'maneli-car-inquiry')); ?>');
                    location.reload();
                } else {
                    alert('<?php echo esc_js(__('Error:', 'maneli-car-inquiry')); ?> ' + (response.data.message || 'Unknown error'));
                }
