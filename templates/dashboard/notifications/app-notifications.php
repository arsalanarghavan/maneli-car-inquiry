...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="card custom-card mb-4">
            ...
            <div class="card-body">
                <form method="get" action="<?php echo esc_url(home_url('/dashboard/notifications/app')); ?>" class="row g-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-12">
                        ...
                        <a href="<?php echo esc_url(home_url('/dashboard/notifications/app')); ?>" class="btn btn-secondary btn-wave">
