...
if (isset($_GET['export']) && $_GET['export'] === 'csv') {
    ...
    fputcsv($output, [
        ...
        esc_html__('Subject', 'maneli-car-inquiry'),
            ...
            <div>
                <nav>
                    <ol class="breadcrumb mb-1">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php esc_html_e('Email Notifications', 'maneli-car-inquiry'); ?></li>
                    </ol>
                </nav>
                <h1 class="page-title mb-0"><?php esc_html_e('Email Notifications', 'maneli-car-inquiry'); ?></h1>
            </div>
        </div>
        <!-- End::page-header -->
            ...
            <div class="col-xl col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card custom-card crm-card overflow-hidden">
                    <div class="card-body">
                        ...
                        <p class="flex-fill text-muted fs-14 mb-1"><?php esc_html_e('Total Emails', 'maneli-car-inquiry'); ?></p>
                        <div class="d-flex align-items-center justify-content-between mt-1">
                ...
                <div class="card custom-card crm-card overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                            ...
                            <span class="badge bg-info-transparent rounded-pill fs-11"><?php esc_html_e('Emails', 'maneli-car-inquiry'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card custom-card crm-card overflow-hidden">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-1">
                            ...
                            <span class="badge bg-secondary-transparent rounded-pill fs-11"><?php esc_html_e('Emails', 'maneli-car-inquiry'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mb-4">
            <div class="col-xl-6">
                <div class="card custom-card">
                    <div class="card-header">
                        <h5 class="mb-0"><?php esc_html_e('Email Timeline', 'maneli-car-inquiry'); ?></h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="card custom-card mb-4">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0"><?php esc_html_e('Email Logs', 'maneli-car-inquiry'); ?></h5>
                    ...
                    <table class="table table-hover text-nowrap">
                        <thead>
                            <tr>
                                ...
                                <th><?php esc_html_e('Subject', 'maneli-car-inquiry'); ?></th>
                            ...
                            <?php if (empty($logs)): ?>
                                <tr>
                                    <td colspan="8" class="text-center py-4">
                                        <p class="text-muted mb-0"><?php esc_html_e('No email notifications found.', 'maneli-car-inquiry'); ?></p>
                                    </td>
                                </tr>
                            <?php else: ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php esc_html_e('Send Single Email', 'maneli-car-inquiry'); ?></h5>
            ...
            <div class="modal-body">
                <form id="sendSingleForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="recipient" id="singleRecipient" class="form-control" required placeholder="<?php esc_attr_e('Email address', 'maneli-car-inquiry'); ?>">
                        <small class="form-text text-muted"><?php esc_html_e('Enter email address or user ID', 'maneli-car-inquiry'); ?></small>
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Subject', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="subject" id="singleSubject" class="form-control" required placeholder="<?php esc_attr_e('Email subject', 'maneli-car-inquiry'); ?>">
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="sendSingleBtn">
                    <i class="ri-send-plane-line me-1"></i>
                    <?php esc_html_e('Send Email', 'maneli-car-inquiry'); ?>
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="sendBulkModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php esc_html_e('Send Bulk Email', 'maneli-car-inquiry'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="bulkNotificationForm">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="custom_recipients" id="bulkCustomRecipients" class="form-control" rows="3" placeholder="<?php esc_attr_e('Or enter custom email addresses (one per line)', 'maneli-car-inquiry'); ?>"></textarea>
                        <small class="form-text text-muted" id="recipientCount"><?php esc_html_e('Select recipients type or enter custom email addresses', 'maneli-car-inquiry'); ?></small>
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Subject', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="subject" id="bulkSubject" class="form-control" required placeholder="<?php esc_attr_e('Email subject', 'maneli-car-inquiry'); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Message', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
...
<div class="modal fade" id="scheduleModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php esc_html_e('Schedule Email', 'maneli-car-inquiry'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <form id="scheduleNotificationForm">
                    ...
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Recipient', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
                        <input type="email" name="recipient" id="scheduleRecipient" class="form-control" required placeholder="<?php esc_attr_e('Email address', 'maneli-car-inquiry'); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Subject', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="subject" id="scheduleSubject" class="form-control" required placeholder="<?php esc_attr_e('Email subject', 'maneli-car-inquiry'); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Message', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="templateForm">
                    ...
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Subject', 'maneli-car-inquiry'); ?></label>
                        <input type="text" name="subject" id="templateSubject" class="form-control" placeholder="<?php esc_attr_e('Email subject (optional)', 'maneli-car-inquiry'); ?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label"><?php esc_html_e('Message', 'maneli-car-inquiry'); ?> <span class="text-danger">*</span></label>
...
jQuery(document).ready(function($) {
                    ...
                    if (response.success && response.data) {
                        var timelineChart = new Chart(timelineCtx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    label: '<?php echo esc_js(__('Sent Emails', 'maneli-car-inquiry')); ?>',
    ...
    $('#sendSingleBtn').on('click', function() {
        ...
        if (!recipient || !subject || !message) {
            alert('<?php echo esc_js(__('Recipient, subject and message are required.', 'maneli-car-inquiry')); ?>');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Email sent successfully!', 'maneli-car-inquiry')); ?>');
            ...
            complete: function() {
                btn.prop('disabled', false).html('<i class="ri-send-plane-line me-1"></i> <?php echo esc_js(__('Send Email', 'maneli-car-inquiry')); ?>');
            }
        });
    });
    ...
    $('#sendBulkBtn').on('click', function() {
        ...
        if (!subject || !message) {
            alert('<?php echo esc_js(__('Subject and message are required.', 'maneli-car-inquiry')); ?>');
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Bulk Email sent successfully!', 'maneli-car-inquiry')); ?>');
    ...
    $('#scheduleBtn').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Email scheduled successfully!', 'maneli-car-inquiry')); ?>');
    ...
    $('.retry-notification').on('click', function() {
        ...
        if (!confirm('<?php echo esc_js(__('Retry sending this email?', 'maneli-car-inquiry')); ?>')) {
            return;
        }
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    alert('<?php echo esc_js(__('Email retried successfully!', 'maneli-car-inquiry')); ?>');
                    location.reload();
                } else {
                    alert('<?php echo esc_js(__('Error:', 'maneli-car-inquiry')); ?> ' + (response.data.message || 'Unknown error'));
                }
