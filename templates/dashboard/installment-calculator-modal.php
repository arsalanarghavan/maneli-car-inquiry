        ...
        <div class="modal-content" style="border-radius: 0.75rem; overflow: hidden; box-shadow: 0 10px 40px rgba(0,0,0,0.15);">
            <div class="modal-header" style="background: linear-gradient(135deg, #2D89BE 0%, #4a54e5 100%); color: #fff; border: none; padding: 1.25rem 1.5rem;">
                <h5 class="modal-title" id="installmentCalculatorModalLabel" style="margin: 0; font-weight: 600; font-size: 1.125rem;">
                    ...
                    <?php esc_html_e('Calculate Installment', 'maneli-car-inquiry'); ?>
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="<?php esc_attr_e('Close', 'maneli-car-inquiry'); ?>" style="filter: brightness(0) invert(1);"></button>
            </div>
            <div class="modal-body" style="padding: 1.5rem;">
                ...
                <div class="maneli-calculator-container" id="modal-calculator-container" style="border: none; box-shadow: none; margin: 0; padding: 0;">
                    <div id="modal-installment-tab" class="tab-content active">
                        ...
                        <form class="loan-calculator-form" method="post" id="modal-calculator-form" style="padding: 0;">
                            ...
                            <div id="modal-loan-calculator" 
                                ...
                                <h2 class="loan-title" style="font-size: 1rem; margin-bottom: 1.5rem; padding-bottom: 0.75rem;"><?php esc_html_e('Budgeting and Installment Calculation', 'maneli-car-inquiry'); ?></h2>
                                <div class="loan-section" style="margin-bottom: 1.5rem;">
                                    <div class="loan-row">
                                        <label class="loan-label" for="modalDownPaymentInput" style="font-size: 0.875rem; margin-bottom: 0.75rem; color: #4d5875;"><?php esc_html_e('Down Payment Amount:', 'maneli-car-inquiry'); ?></label>
                                    ...
                                    <div class="loan-note" style="font-size: 0.8125rem; color: #6e829f; margin-top: 0.5rem;">
                                        ...
                                        <span style="font-weight: 600; color: #2D89BE;">
                                            <span id="modalMinDownDisplay">0</span> <?php esc_html_e('Toman', 'maneli-car-inquiry'); ?>
                                        </span>
                                    </div>
                                </div>
                                <div class="loan-section" style="margin-bottom: 1.5rem;">
                                    <label class="loan-label" style="font-size: 0.875rem; margin-bottom: 0.75rem; color: #4d5875;"><?php esc_html_e('Repayment Period:', 'maneli-car-inquiry'); ?></label>
                                    <div class="loan-buttons" style="gap: 0.625rem;">
                                        <button type="button" class="term-btn active" data-months="12" style="padding: 0.625rem 1rem; border-radius: 0.5rem; font-weight: 500;"><?php esc_html_e('12 Months', 'maneli-car-inquiry'); ?></button>
                                        <button type="button" class="term-btn" data-months="18" style="padding: 0.625rem 1rem; border-radius: 0.5rem; font-weight: 500;"><?php esc_html_e('18 Months', 'maneli-car-inquiry'); ?></button>
                                        <button type="button" class="term-btn" data-months="24" style="padding: 0.625rem 1rem; border-radius: 0.5rem; font-weight: 500;"><?php esc_html_e('24 Months', 'maneli-car-inquiry'); ?></button>
                                        <button type="button" class="term-btn" data-months="36" style="padding: 0.625rem 1rem; border-radius: 0.5rem; font-weight: 500;"><?php esc_html_e('36 Months', 'maneli-car-inquiry'); ?></button>
                                    </div>
                                </div>
                                <div class="loan-section result-section" style="background: linear-gradient(135deg, rgba(45, 137, 190, 0.1) 0%, rgba(74, 84, 229, 0.1) 100%); border: 2px solid #2D89BE; border-radius: 0.75rem; padding: 1.5rem; margin-top: 1.5rem;">
                                    <strong style="font-size: 0.9375rem; color: #212b37; display: block; margin-bottom: 0.75rem;"><?php esc_html_e('Approximate Installment Amount:', 'maneli-car-inquiry'); ?></strong>
                                    <div style="font-size: 1.75rem; font-weight: 700; color: #2D89BE; line-height: 1.2;">
                                        <span id="modalInstallmentAmount">0</span>
                                        <span style="font-size: 0.875rem; font-weight: 500; margin-right: 0.25rem;"><?php esc_html_e('Toman', 'maneli-car-inquiry'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="modal-footer" style="border-top: 1px solid #e2e6f1; padding: 1rem 1.5rem; background: #f8f9fa;">
                ...
                <button type="button" class="btn btn-primary" id="modalConfirmCarBtn" style="background: linear-gradient(135deg, #2D89BE 0%, #4a54e5 100%); border: none; border-radius: 0.5rem; padding: 0.625rem 1.5rem; font-weight: 500; box-shadow: 0 4px 12px rgba(45, 137, 190, 0.3); transition: all 0.3s ease;">
                    ...
                    <?php esc_html_e('Confirm and Replace Car', 'maneli-car-inquiry'); ?>
                </button>
            </div>
        </div>
    </div>
