...
<div class="row" id="installment-inquiry-details" data-inquiry-id="<?php echo esc_attr($inquiry_id); ?>" data-inquiry-type="installment">
    <div class="col-xl-12">
        ...
        <?php if ($is_admin && $credit_risk_enabled && !empty($credit_risk_data)): ?>
        <!-- Credit Risk Card -->
        <div class="card custom-card mt-3">
        ...
        <?php if ($is_admin && $credit_score_enabled && !empty($credit_score_data)): ?>
        ...
        <?php if ($is_admin && $collaterals_enabled && !empty($collaterals_data)): ?>
        ...
        <?php if ($is_admin && $cheque_color_enabled && (!empty($finotex_data) || !empty($cheque_color_data))): ?>
        ...
        $(document).off('click.emergency', '.send-sms-report-btn').on('click.emergency', '.send-sms-report-btn', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed && result.value) {
                    ...
                    // Get AJAX URL and nonce - try multiple sources (prioritize maneliAjaxUrl and maneliAjaxNonce)
                    var ajaxUrl = '';
                    var ajaxNonce = '';
