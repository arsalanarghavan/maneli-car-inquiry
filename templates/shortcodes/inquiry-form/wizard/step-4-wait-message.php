...
$default_wait = esc_html__('Your request has been registered. The result will be announced within the next 24 hours.', 'maneli-car-inquiry');
...
if (!empty($_GET['status']) && $_GET['status'] === 'success' && !empty($options['msg_after_approval'])) {
    ...
    $message = esc_html__('Our experts need more documents to complete the process. Please wait for our team to contact you.', 'maneli-car-inquiry');
} else {
