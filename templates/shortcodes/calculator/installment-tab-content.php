     ...
     <form class="loan-calculator-form<?php echo (isset($installment_unavailable) && $installment_unavailable) ? ' unavailable-form' : ''; ?>" method="post">
        ...
        <div id="loan-calculator-modal" 
            ...
            <div class="loan-section">
                <div class="loan-row">
                    <label class="loan-label" for="downPaymentInputModal"><?php esc_html_e('Down Payment Amount:', 'autopuzzle'); ?></label>
                    <input type="text" id="downPaymentInputModal" step="1000000">
                </div>
                <input type="range" id="downPaymentSliderModal" step="1000000">
                <div class="loan-note">
                    ...
                    <span>
                        ...
                        <?php elseif (isset($can_see_prices) && !$can_see_prices): ?>
                            ...
                            <span id="minDownDisplayModal" style="display:none;"><?php echo esc_html(number_format_i18n($min_down_payment ? $min_down_payment : 0)); ?></span>
                        <?php else: ?>
                            <span id="minDownDisplayModal"><?php echo esc_html(number_format_i18n($min_down_payment ? $min_down_payment : 0)); ?></span> <?php esc_html_e('Toman', 'autopuzzle'); ?>
                        <?php endif; ?>
                    </span>
                </div>
            </div>
            ...
            <div class="loan-section result-section">
                ...
                <?php if (isset($installment_unavailable) && $installment_unavailable): ?>
                    <span class="unavailable-text"><?php esc_html_e('ناموجود', 'autopuzzle'); ?></span>
                    <span id="installmentAmountModal" style="display:none;">0</span>
                <?php elseif (isset($can_see_prices) && !$can_see_prices): ?>
                    <span class="price-hidden">-</span>
                    <span id="installmentAmountModal" style="display:none;">0</span>
                <?php else: ?>
                    <span id="installmentAmountModal">0</span>
