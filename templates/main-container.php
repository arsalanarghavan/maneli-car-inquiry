...
@media (max-width: 768px) {
    .autopuzzle-calculator-container .cash-request-form .form-row {
    ...
    <div class="tabs-content-wrapper">
        ...
        <div id="cash-tab" class="tab-content">
             <form class="loan-calculator-form cash-request-form" method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                ...
                <div class="autopuzzle-price-disclaimer">
                ...
                <?php else: // User is not logged in ?>
                    <div class="loan-section" style="text-align: center;">
                        ...
                        <a href="<?php echo esc_url(home_url('/dashboard/')); ?>" class="loan-action-btn"><?php esc_html_e('Login and Submit Request', 'autopuzzle'); ?></a>
                    </div>
                <?php endif; ?>
            </form>
        </div>
                ...
                <div id="loan-calculator" data-price="<?php echo esc_attr($installment_price); ?>" data-min-down="<?php echo esc_attr($min_down_payment); ?>" data-max-down="<?php echo esc_attr($max_down_payment); ?>">
                    ...
                    <div class="loan-section">
                        ...
                        <div class="loan-note">
                            ...
                            <span><span id="minDownDisplay">0</span> <?php esc_html_e('Toman', 'autopuzzle'); ?></span>
                        </div>
                    </div>
                    <div class="loan-section">
       ...
       <?php if (is_user_logged_in()): ?>
                        ...
                        <?php else: ?>
                            <a href="<?php echo esc_url(home_url('/dashboard/')); ?>" class="loan-action-btn"><?php esc_html_e('Log in to Start Inquiry', 'autopuzzle'); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </form>
