...
(() => {
  ...
  function rtlFn() {
    ...
    if (window.rtlFnOverride) {
      window.rtlFnOverride();
    } else {
      let html = document.querySelector("html");
      html.setAttribute("dir", "rtl");
      var pluginUrl = window.MANELI_PLUGIN_URL || '/wp-content/plugins/maneli-car-inquiry/';
    ...
    if (localStorage.getItem("xintrartl")) {
      var rtlCheckbox = document.querySelector("#switcher-rtl");
      if (rtlCheckbox) {
