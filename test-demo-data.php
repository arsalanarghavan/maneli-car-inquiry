...
echo "- class_exists('Maneli_Database'): " . ( class_exists( 'Maneli_Database' ) ? 'YES' : 'NO' ) . "\n";
echo "- class_exists('Maneli_CPT_Handler'): " . ( class_exists( 'Maneli_CPT_Handler' ) ? 'YES' : 'NO' ) . "\n";
echo "- class_exists('Maneli_Demo_Data_Generator'): " . ( class_exists( 'Maneli_Demo_Data_Generator' ) ? 'YES' : 'NO' ) . "\n";
...
if ( class_exists( 'Maneli_Demo_Data_Generator' ) ) {
    ...
    echo "ERROR: Maneli_Demo_Data_Generator class not found!\n";
}
